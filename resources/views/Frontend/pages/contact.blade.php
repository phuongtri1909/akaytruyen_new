    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted">Kết nối với AKAY TRUYỆN qua các kênh chính thức</p>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="social-card facebook-card">
                            ...
                            <a href="https://www.facebook.com/groups/1134210028188278/" target="_blank" class="btn btn-primary btn-md">
