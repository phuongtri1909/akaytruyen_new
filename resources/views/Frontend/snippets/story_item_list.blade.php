<div class="story-item-list d-flex align-items-center position-relative mb-2">
    <a href="{{ route('story', ['slug' => $story->slug]) }}" class="d-block story-item-list__image mb-1 me-3">
        <img src="{{ \App\Helpers\Helper::getStoryImageUrl($story->image) }}" alt="{{ $story->name }}" class="img-fluid w-100" width="100" height="150" loading='lazy'>
    </a>
    ...
    <div class="story-info d-flex justify-content-between align-items-start flex-wrap">
        <div class="d-flex flex-column">
            ...
            <span class="text-secondary">
                ...
                <a href="#" class="hover-title text-decoration-none text-dark author-name">{{ $story->author?->name ?? 'Chưa xác định' }}</a>
            </span>
        </div>
