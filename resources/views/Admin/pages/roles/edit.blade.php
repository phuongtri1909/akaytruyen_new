    ...
    <div class="category-form-container">
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <div class="role-meta">
                    <div class="role-badge name">
                        <i class="fas fa-tag"></i>
                        <span>{{ $role->name }}</span>
                    </div>
                    <div class="role-badge permissions-count">
                        <i class="fas fa-key"></i>
                        <span>{{ $role->permissions->count() }} quyền</span>
                    </div>
                    <div class="role-badge created">
                        <i class="fas fa-calendar"></i>
                        <span>Ngày tạo: {{ $role->created_at->format('d/m/Y H:i') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-body">
                ...
                <form action="{{ route('admin.roles.update', $role) }}" method="POST" class="role-form" id="role-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-tabs">
                        <div class="form-group">
                            <label for="name" class="form-label-custom">
                                ...
                                @else
                                    <span class="protected-mark" title="Tên vai trò được bảo vệ">
                                        <i class="fas fa-shield-alt"></i>
                                    </span>
                                @endif
                            </label>
                            <input type="text" id="name" name="name"
                                class="custom-input {{ $errors->has('name') ? 'input-error' : '' }} {{ $role->protected ? 'input-disabled' : '' }}"
                            ...
                            @if ($role->protected)
                                <div class="protected-notice">
                                    ...
                                    Tên vai trò này được bảo vệ và không thể thay đổi
                                </div>
                            @endif
                        ...
                        @else
                            <div class="form-group">
                                <div class="alert alert-warning">
                                    ...
                                    <strong>Thông báo:</strong> Bạn chỉ có quyền chỉnh sửa tên vai trò mà không thể thay đổi quyền. Quyền hiện tại sẽ được giữ nguyên.
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Thành công',
                            text: response.message || 'Vai trò đã được cập nhật thành công!',
                            timer: 2000,
